...
SETUP_THREAD_0_0:
  ...
  set 0x40013fa0, %sp  ! set stack address
  clr %fp
...
SETUP_THREAD_0_1:
  ...
  set 0x40016fa0, %sp  ! set stack address
  clr %fp
...
__cortos_init_region_to_zero:
  ...
  sethi %hi(0x4000b000), %l0
  or %l0, %lo(0x4000b000), %l0

  ! set the first illegal address
  sethi %hi(0x4000e000), %l2
  or %l2, %lo(0x4000e000), %l2
...
_cortos_zero_init_area_BssSection:
  ...
  ! set the base address
  sethi %hi(0x4000e000), %l0
  or %l0, %lo(0x4000e000), %l0

  ! set the first illegal address
  sethi %hi(0x4000f000), %l2
  or %l2, %lo(0x4000f000), %l2
  sub %l2, 0x4, %l2         ! address of last valid word location
...
_cortos_zero_init_area_CacheableLocks:
  ...
  ! set the base address
  sethi %hi(0x4000f000), %l0
  or %l0, %lo(0x4000f000), %l0

  ! set the first illegal address
  sethi %hi(0x40010000), %l2
  or %l2, %lo(0x40010000), %l2
  sub %l2, 0x4, %l2         ! address of last valid word location
